...
| <a name="input_customer_gateway_name"></a> [customer\_gateway\_name](#input\_customer\_gateway\_name) | The Name of the Customer Gateway. | `string` | `""` | no |
...
| <a name="input_vpc_name"></a> [vpc\_name](#input\_vpc\_name) | The Name of the VPC where the VPN Gateway lives. | `string` | `null` | no |
